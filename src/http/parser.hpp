#ifndef _CUCKOOSNIFFER_HTTP_PARSER_HTTP_PARSER_HPP_
#define _CUCKOOSNIFFER_HTTP_PARSER_HTTP_PARSER_HPP_
...
namespace cs::http {
    ...
    protected:
        std::queue<HTTPData*> completed_data_;
        HTTPData* current_data_;
        HTTPData* get_data();
    ...
    class HTTPRequestParser: public HTTPParser {
        friend class cs::http::HTTPParser;
        friend class cs::http::HTTPRequest;
    private:
    public:
        HTTPRequestParser();
    ...
    class HTTPResponseParser: public HTTPParser {
        friend class cs::http::HTTPParser;
        friend class cs::http::HTTPResponse;
    private:
    public:
        HTTPResponseParser();
...
#endif //_CUCKOOSNIFFER_HTTP_PARSER_HTTP_PARSER_HPP_
