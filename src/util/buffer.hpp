#ifndef _CUCKOO_SNIFFER_UTIL_BUFFER_HPP_
#define _CUCKOO_SNIFFER_UTIL_BUFFER_HPP_
...
//        friend std::istream & operator>>(std::istream &, Buffer&);
    ...
    public:
        ...
        size_t write_to_pos(const char*, size_t, size_t);
...
#endif //_CUCKOO_SNIFFER_UTIL_BUFFER_HPP_
